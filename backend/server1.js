...
app.post("/appointments", verifyToken, async (req, res) => {
  try {
    ...
    // Check for existing appointment with same counselor/date/time in pending or accepted status
...
app.get('/appointments', verifyToken, async (req, res) => {
  try {
    ...
    // If user requests own appointments
    if (req.path === '/appointments' && req.user && !req.user.role) {
...
// GET /appointments/mine for explicit user appointments
